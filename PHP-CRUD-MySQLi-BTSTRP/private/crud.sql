...
--
-- Host: localhost
-- Generation Time: Sep 22, 2019 at 05:58 PM
...
GRANT SELECT, INSERT, UPDATE, DELETE, CREATE ON *.* TO 'crud'@'localhost' IDENTIFIED BY PASSWORD '*2470C0C06DEE42FD1618BB99005ADCA2EC9D1E19';
